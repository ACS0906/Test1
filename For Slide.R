...
#=====================Data Generation for classical CCA =============================
set.seed(01)
mu=rep(0,6)
...
orginal=L;PV;df
Table1=round(data.frame(CanCorr=can.corr,Chisquare=L,df=df,p.value=PV),3);Table1
################## canonical weights 
a<-sr11%*%sd$u
...
ppevx<-pevx*100;ppevx
ppevy<-pevy*100;ppevy
...
Table=round(data.frame(Rx,Ry),3);Table
...
#================================================================
#=================================================================
###=============robust data generation and cca calculation #######
#===================================================================
#==================================================================
...
conta=matrix(rep(round(5*as.numeric(apply(Data,2,max))+rnorm(6,0,1)),5),5)
CData=rbind(Data,conta)
